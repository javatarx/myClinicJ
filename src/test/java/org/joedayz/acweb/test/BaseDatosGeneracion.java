...
private BaseDaoSupport daoSupport= new BaseDaoSupport();
	...
	public void ExecuteSql() throws Exception{
		...
		list.add(sql);
			...
			sql = "INSERT INTO ESPECIALIDAD (CO_ESPECIALIDAD,DE_ESPECIALIDAD,ST_ESPECIALIDAD) VALUES (1,'MEDICINA GENERAL',"+true+"); ";
		list.add(sql);
		
			sql = "INSERT INTO ESPECIALIDAD (CO_ESPECIALIDAD,DE_ESPECIALIDAD,ST_ESPECIALIDAD) VALUES (2,'TRAUMATOLOGIA',"+true+"); ";
		list.add(sql);
		
			sql = "INSERT INTO ESPECIALIDAD (CO_ESPECIALIDAD,DE_ESPECIALIDAD,ST_ESPECIALIDAD) VALUES (3,'CARDIOLOGIA',"+true+"); ";
		list.add(sql);
		
			sql = "INSERT INTO ESPECIALIDAD (CO_ESPECIALIDAD,DE_ESPECIALIDAD,ST_ESPECIALIDAD) VALUES (4,'DERMATOLOGIA',"+true+"); ";
		list.add(sql);
		
			sql = "INSERT INTO ESPECIALIDAD (CO_ESPECIALIDAD,DE_ESPECIALIDAD,ST_ESPECIALIDAD) VALUES (5,'NEONATOLOGIA',"+true+"); ";
		list.add(sql);
		...
		list.add(sql);
			...
			sql = "INSERT INTO MEDICO (CO_MEDICO,DE_MEDICO,ST_MEDICO,CO_ESPECIALIDAD) VALUES(1,'LUPA QUISOLACA HERNAN',"+true+",1);";
		list.add(sql);
		
			sql = "INSERT INTO MEDICO (CO_MEDICO,DE_MEDICO,ST_MEDICO,CO_ESPECIALIDAD) VALUES(2,'LUQUE MAMANI ELOY',"+true+",2);";
		list.add(sql);
		
			sql = "INSERT INTO MEDICO (CO_MEDICO,DE_MEDICO,ST_MEDICO,CO_ESPECIALIDAD) VALUES(3,'MARIN VEGA CESAR',"+true+",3);";
		list.add(sql);
		
			sql = "INSERT INTO MEDICO (CO_MEDICO,DE_MEDICO,ST_MEDICO,CO_ESPECIALIDAD) VALUES(4,'PASSANO DEL CARPIO AGUSTIN',"+true+",4);";
		list.add(sql);
		
			sql = "INSERT INTO MEDICO (CO_MEDICO,DE_MEDICO,ST_MEDICO,CO_ESPECIALIDAD) VALUES(5,'PORTUGAL GALDOS ENRIQUE',"+true+",5);";
		list.add(sql);

			sql = "INSERT INTO MEDICO (CO_MEDICO,DE_MEDICO,ST_MEDICO,CO_ESPECIALIDAD) VALUES(6,'SOTOMAYOR PERALES ENRIQUE',"+true+",1);";
		list.add(sql);
	
			sql = "INSERT INTO MEDICO (CO_MEDICO,DE_MEDICO,ST_MEDICO,CO_ESPECIALIDAD) VALUES(7,'ZEGARRA MACEDO ANGEL',"+true+",2);";
		list.add(sql);
	
			sql = "INSERT INTO MEDICO (CO_MEDICO,DE_MEDICO,ST_MEDICO,CO_ESPECIALIDAD) VALUES(8,'VEGA HINOJOSA OSCAR',"+true+",3);";
		list.add(sql);
	
			sql = "INSERT INTO MEDICO (CO_MEDICO,DE_MEDICO,ST_MEDICO,CO_ESPECIALIDAD) VALUES(9,'AGUILAR RIOS CHRISTIAN',"+true+",4);";
		list.add(sql);
	
			sql = "INSERT INTO MEDICO (CO_MEDICO,DE_MEDICO,ST_MEDICO,CO_ESPECIALIDAD) VALUES(10,'HUAMALIES BAQUERIZO NORCA',"+true+",5);";
		list.add(sql);
