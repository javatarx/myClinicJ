...
import org.joedayz.acweb.cita.EstadoCita;
...
public class BNCita implements Serializable {
	...
	public BNCita(Long coCita, BNMedico medico, BNUsuario usuario, BNEspecialidad especialidad, Date fecha,
			String horario, String comentario) {
		super();
		this.coCita = coCita;
		this.medico = medico;
	...
	@Column(name = "ST_CITA")
	public int getStCita() {
		return stCita;
	}

	public void setStCita(int stCita) {
		this.stCita = stCita;
	}
	...
	public EstadoCita getEstado() {
		return FactoryEstadoCita.getEstadoCita(this.stCita);
	}
